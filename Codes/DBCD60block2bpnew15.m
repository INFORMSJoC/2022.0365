function [aa,aax,bb,o,x0,y0]=DBCD60block2bpnew15(x,y,r,th,p,lanf,c,qq,h,d)
%内点法，包含偏置项，分块，反向算法，算法修改为反向迭代库存更新，删除if语句，考虑订货量和需求不为负数，多步预测,修改b的计算
n1=12;%length(x(1,1,1,:,1));
n2=length(x(1,1,:,1,1));
n3=length(x(1,:,1,1,1));
n4=length(x(:,1,1,1,1));
...
for i=1:n4
    for j=1:n3
        for tt=1:n1
            ...
            ytrain1(i,j,:,t)=DBCD32bnew11gg(aa,aax,bb,r,th,x,y,lanf,c,qq,p,t,j,i,ytrain1);
            toc
        end
    end    
end