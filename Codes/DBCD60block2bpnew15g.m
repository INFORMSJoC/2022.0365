function [aa,aax,bb,o,x0,y0]=DBCD60block2bpnew15g(x,y,r,th,p,lanf,c,qq,h,d,C,B)
n1=length(x(1,1,1,:,1));
n2=length(x(1,1,:,1,1));
n3=length(x(1,:,1,1,1));
n4=length(x(:,1,1,1,1));
...
for i=1:n4
    for j=1:n3
        for tt=1:n1
            ...
            ytrain1(i,j,:,t)=DBCD32bnew11ggg(aa,aax,bb,r,th,x,y,lanf,c,qq,p,t,j,i,ytrain1,ytrain2(i,:),ytrain3(j,:));
